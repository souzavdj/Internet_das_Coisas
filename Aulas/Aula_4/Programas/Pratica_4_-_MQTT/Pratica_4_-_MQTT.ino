...
#define TOPICO_SUBSCRIBE_P1 "vinicius/LED"     //tópico MQTT de escuta luz 1



                                                   
#define ID_MQTT  "ID_MQTT_VINICIUS"     //id mqtt (para identificação de sessão)
                               //IMPORTANTE: este deve ser único no broker (ou seja, 
                               //            se um client MQTT tentar entrar com o mesmo 
                               //            id de outro já conectado ao broker, o broker 
                               //            irá fechar a conexão de um deles).

#define USER_MQTT  "vinigu"   // usuario no MQTT
#define PASS_MQTT  "testefunciona123"  // senha no MQTT 
...
void initOTA()
{
  ...
  ArduinoOTA.setHostname("vinicius-denis-ota"); // Define o nome da porta
